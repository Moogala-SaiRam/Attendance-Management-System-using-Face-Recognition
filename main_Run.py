    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='Sairam@2004', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:\\Attendance-Project\\Attendance\\Manually Attendance' + DB_table_name + '.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen('explorer /select,"C:\\Attendance-Project\\Attendance\\Manually Attendance\\-------Check atttendance-------"')
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='Sairam@2004', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='grey80')
                cs = 'C:\\Attendance-Project\\Attendance' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            'explorer /select,"C:\\Attendance-Project\\Attendance\\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'pragya':
            if password == 'pragya123':
                ...
                cs = 'C:\\Attendance-Project\\StudentDetails\\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
